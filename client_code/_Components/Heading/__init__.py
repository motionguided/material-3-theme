...
class Heading(HeadingTemplate):
    ...
    def _set_text(self, value):
        self.dom_nodes['anvil-m3-heading-display'].innerText = str(
            value if value is not None else ""
        )
        self.dom_nodes['anvil-m3-heading-headline'].innerText = str(
            value if value is not None else ""
        )
        self.dom_nodes['anvil-m3-heading-title'].innerText = str(
            value if value is not None else ""
        )
    ...
    def underline(self, value) -> bool:
        ...
        if value:
            self.dom_nodes[
                'anvil-m3-heading-display'
            ].style.textDecoration = 'underline'
            self.dom_nodes[
                'anvil-m3-heading-headline'
            ].style.textDecoration = 'underline'
    ...
    def scale(self, value):
        self.dom_nodes['anvil-m3-heading-display'].classList.remove(
            'anvil-m3-heading-large',
            'anvil-m3-heading-medium',
            'anvil-m3-heading-small',
        )
        ...
        self.dom_nodes['anvil-m3-heading-title'].classList.add(
            f'anvil-m3-heading-{value}'
        )
        self.dom_nodes['anvil-m3-heading-container'].classList.add(
            f'anvil-m3-heading-{value}'
