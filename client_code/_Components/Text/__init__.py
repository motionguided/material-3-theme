...
class Text(TextTemplate):
    def __init__(self, **properties):
        ...
        self._set_designer_text_placeholder, self._start_inline_editing = (
            inline_editing(self, self.dom_nodes['anvil-m3-text'], self._set_text)
        )
        self.init_components(**properties)

    def _set_text(self, value):
        self.dom_nodes['anvil-m3-text'].innerText = str(
    ...
    def _anvil_get_unset_property_values_(self):
        ...
        tfs = get_unset_value(
            self.dom_nodes['anvil-m3-text'], "fontSize", self.font_size
        )
        ifs = get_unset_value(
